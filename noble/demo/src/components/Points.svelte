...
<h3 class="header">Demo 2: Elliptic curve point operations (add, subtract, multiply)</h3>
<p class="subheader">
  This form allows adding, subtracting, and multiplying points on the chosen elliptic curve.
  By default, random coordinates are generated for A and B points.
</p>
